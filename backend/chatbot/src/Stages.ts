...
export function stage0(nextStage: number) {
    nextStage = 1
    const message: string = 'Olá, eu sou o bot do preciso. Se você tem interesse em doar eletrônicos digite: Sim, e siga as próximas instruções atentamente'
    return [message, nextStage]
}
